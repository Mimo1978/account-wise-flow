...
const createTalentNode = (engagement: TalentEngagementWithData, x: number, y: number): Group => {
  ...
  const badgeBg = new Rect({ width: 64, height: 20, fill: "hsl(221 83% 53%)", rx: 10, ry: 10, originX: "center", originY: "center", left: 0, top: -52 });
  const badgeText = new Text("TALENT", { fontSize: 8, fontWeight: "bold", fill: "white", originX: "center", originY: "center", left: 0, top: -52 });
