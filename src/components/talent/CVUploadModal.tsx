...
export function CVUploadModal({
  ...
  const { uploadCV, validateFile, isUploading } = useCandidateCV();
  ...
  const handleUpload = async () => {
    ...
    const success = await uploadCV(candidateId, selectedFile);
    ...
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && handleClose()}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a CV for {candidateName}. Accepted formats: PDF, DOC, DOCX.
          </DialogDescription>
        </DialogHeader>
