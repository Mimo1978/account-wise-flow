...
export const navigationMap: Record<string, NavigationEntry> = {
  ...
  outreachQueue: {
    ...
    label: "Target Queue",
    action: "click",
    targetId: "outreach-tab-queue",
    keywords: ["target queue", "outreach queue", "queue tab"],
  },
  outreachCampaigns: {
    path: "/outreach",
    label: "Campaigns",
    action: "click",
    targetId: "outreach-tab-campaigns",
    keywords: ["campaigns tab", "outreach campaigns", "show campaigns", "open campaigns"],
  },
  outreachScripts: {
    path: "/outreach",
    label: "Scripts",
    action: "click",
    targetId: "outreach-tab-scripts",
    keywords: ["scripts tab", "outreach scripts", "call scripts tab", "show scripts", "open scripts"],
  },
  jobOverview: {
    path: "/jobs/:id",
    label: "Job Overview",
    action: "click",
    targetId: "job-tab-overview",
    keywords: ["job overview tab", "job overview"],
  },
  jobAdverts: {
    path: "/jobs/:id",
    label: "Job Adverts",
    action: "click",
    targetId: "job-tab-adverts",
    keywords: ["job adverts tab", "adverts tab", "show adverts"],
  },
  jobShortlist: {
    path: "/jobs/:id",
    label: "Job Shortlist",
    action: "click",
    targetId: "job-tab-shortlist",
    keywords: ["job shortlist tab", "shortlist tab", "show shortlist"],
  },
  jobOutreach: {
    path: "/jobs/:id",
    label: "Job Outreach",
    action: "click",
    targetId: "job-tab-outreach",
    keywords: ["job outreach tab", "outreach tab on job"],
  },
  jobApplications: {
    path: "/jobs/:id",
    label: "Job Applications",
    action: "click",
    targetId: "job-tab-applications",
    keywords: ["job applications tab", "applications tab", "show applications"],
  },
  jobActivity: {
    path: "/jobs/:id",
    label: "Job Activity",
    action: "click",
    targetId: "job-tab-activity",
    keywords: ["job activity tab", "activity tab on job"],
  },
  companyOverview: {
    path: "/companies/:id",
    label: "Company Overview",
    action: "click",
    targetId: "company-tab-overview",
    keywords: ["company overview tab"],
  },
  companyContacts: {
    path: "/companies/:id",
    label: "Company Contacts",
    action: "click",
    targetId: "company-tab-contacts",
    keywords: ["company contacts tab", "show company contacts"],
  },
  companyDeals: {
    path: "/companies/:id",
    label: "Company Deals",
    action: "click",
    targetId: "company-tab-deals",
    keywords: ["company deals tab", "show company deals"],
  },
  companyProjects: {
    path: "/companies/:id",
    label: "Company Projects",
    action: "click",
    targetId: "company-tab-projects",
    keywords: ["company projects tab"],
  },
  companyDocuments: {
    path: "/companies/:id",
    label: "Company Documents",
    action: "click",
    targetId: "company-tab-documents",
    keywords: ["company documents tab"],
  },
  companyActivities: {
    path: "/companies/:id",
    label: "Company Activities",
    action: "click",
    targetId: "company-tab-activities",
    keywords: ["company activities tab", "company activity tab"],
  },
  companyCanvas: {
    path: "/companies/:id",
    label: "Company Canvas",
    action: "click",
    targetId: "company-tab-canvas",
    keywords: ["company canvas tab", "company org chart tab"],
  },
  companyInvoices: {
    path: "/companies/:id",
    label: "Company Invoices",
    action: "click",
    targetId: "company-tab-invoices",
    keywords: ["company invoices tab", "company billing tab"],
  },
