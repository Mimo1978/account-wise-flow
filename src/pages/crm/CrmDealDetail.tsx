            ...
            <CardContent className="py-4">
              ...
              <div className="flex items-center gap-1">
                {['lead', 'qualified', 'proposal', 'negotiation', 'won'].map((s, i) => {
                  ...
                  const isPast = ['lead', 'qualified', 'proposal', 'negotiation', 'won'].indexOf(deal.stage) >= i;
                  return (
          ...
          <Card>
            <CardContent className="py-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                ...
                <div><span className="text-muted-foreground">Probability</span><p className="text-lg font-bold">{deal.probability ?? 0}%</p></div>
                <div><span className="text-muted-foreground">Weighted Value</span><p className="text-lg font-bold">{currencySymbol}{Math.round(deal.value * (deal.probability ?? 0) / 100).toLocaleString()}</p></div>
